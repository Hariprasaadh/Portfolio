    ...
    },
    {
      ...
      skills: [
        ...
        },
        {
          name: "Qdrant",
          image:
            "https://avatars.githubusercontent.com/u/153958985?s=280&v=4",
        }
      ],
    },
    {
...
export const experiences = [
    {
      ...
      desc: "Currently working on an Intelligent Agentic Communication App, where I am contributing to building AI-driven agentic orchestration, developing automation workflows, and integrating the system with cloud and mobile platforms to enhance user productivity.",
      skills: [
        "Tensorflow Lite",
        "React Native",
        "Firebase",
    ...
    {
      id: 1,
      img: "annam_ai_logo.jpeg",
      role: "Project Intern",
      company: "Annam.ai",
      date: "May 2025 - Aug 2025",
      desc: "Worked on Agronome, a comprehensive smart agriculture platform designed to revolutionize farming practices in India through AI-powered insights, real-time analytics, and user-friendly mobile interfaces. My contributions included building an LLM-based Agentic Chatbot with RAG, developing Computer Vision models for farming applications, and fully integrating the backend with the frontend using FastAPI, ensuring a seamless end-to-end solution.",
      skills: [
        "TensorFlow",
        "OpenCV",
        "LLM",
